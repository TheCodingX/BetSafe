...
async function cycle() {
  ...
  // Todas las sources corren en cada ciclo (cada 30s default). Si necesitás
  // diferenciar frecuencia por source, mejor configurar cache TTL por scraper
  // en sus propios archivos en vez de skipear ciclos enteros — skipear puede
  // dejar el sistema sin data por minutos completos en ciertas condiciones.
