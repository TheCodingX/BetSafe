...
const ENABLED_BOOKS         = (process.env.ENABLED_BOOKS || 'bplay,betano,betwarrior,bet365ar,codere,caliente,casinomagic,betsson,jugabet,24bet,playcity,megapuesta').split(',').map(s=>s.trim()).filter(Boolean);
