...
(function (global) {
  ...
  const PATH = {
    ...
    sparkle: 'M12 3l1.5 5.5L19 10l-5.5 1.5L12 17l-1.5-5.5L5 10l5.5-1.5L12 3zM19 14l.8 2.7L22 17.5l-2.2.8L19 21l-.8-2.7L16 17.5l2.2-.8L19 14zM5 14l.6 2L7 16.6l-1.4.4L5 19l-.6-2L3 16.6l1.4-.4L5 14z',
    ...
    // Settings: cog Lucide-style — círculo central + 8 dientes suaves.
    // Reemplazo (2026-05-18) del path anterior que era jagged/feo.
