...
(function () {
  ...
  async function render(panel) {
    ...
    panel.innerHTML = `
      ...
      <!-- Brief del día REMOVIDO 2026-05-17 a pedido del user — la generación
           del daily-report era inestable: el endpoint /api/daily-report podía
           tardar 30s+ o fallar por rate-limit IA, y el banner quedaba pegado
           mostrando "No pudimos generar el brief en este momento. Reintentando…"
           en loop. La landing va directo a Próximos eventos. -->
    ...
    // Daily brief removido (loop "Reintentando…" molestaba). Sin llamada.
    // loadDailyBrief(panel);  // <- DISABLED 2026-05-17
