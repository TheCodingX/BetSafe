...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    // Service Worker REMOVIDO 2026-05-17 — causaba múltiples bugs de cache
    // stale persistente (combos viejos, UI no actualizada tras deploys).
    // Los browsers que aún tengan /sw.js registrado de versiones viejas van
    // a fetchearlo, ejecutar el "killer" que desregistra + borra caches +
    // recarga la pestaña, y nunca más van a tener SW activo.
    // NO RE-AGREGAR sin un plan claro de invalidación.
  });
